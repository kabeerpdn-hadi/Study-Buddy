...
const BottomNav = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 flex md:hidden bg-gray-900 p-4 justify-around z-50">
            ...
            {isMoreOpen && (
                <div className="fixed bottom-20 right-4 bg-gray-800 rounded-2xl p-4 flex flex-col gap-3">
                    <Link to="/feedback" className="flex items-center gap-2 text-gray-300 hover:text-white font-bold" onClick={() => setIsMoreOpen(false)}>
