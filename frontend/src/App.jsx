...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/courses/:id" element={<Layout><CourseDetailPage key={location.key} /></Layout>} />
      <Route path="/courses/:courseId/lessons/:lessonId" element={<Layout><LessonPage /></Layout>} />
